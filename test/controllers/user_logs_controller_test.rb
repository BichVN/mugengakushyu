...
class UserLogsControllerTest < ActionController::TestCase
  ...
  test "should create user_log" do
    assert_difference('UserLog.count') do
      post :create, user_log: { integer: @user_log.integer, log_data: @user_log.log_data, user_id: @user_log.user_id }
    end
  ...
  test "should update user_log" do
    patch :update, id: @user_log, user_log: { integer: @user_log.integer, log_data: @user_log.log_data, user_id: @user_log.user_id }
    assert_redirected_to user_log_path(assigns(:user_log))
  end
